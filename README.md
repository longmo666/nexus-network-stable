...
curl -O https://raw.githubusercontent.com/longmo666/nexus-network-stable/main/1.sh && chmod +x  1.sh && ./1.sh
...
curl -O https://raw.githubusercontent.com/longmo666/nexus-network-stable/main/nexus-network && chmod +x nexus-network
